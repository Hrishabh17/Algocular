...
async function bubble_sort()
{
    ...
    for(let i=0;i<bars.length;i+=1)
    {
        algo_main.innerHTML=`<li class="class1">for i=0 to array.length</li><li id="list7"> {</li>
                             <li id="list2">for j=0 to last unsorted</li><li id="list6"> {</li>
                             <li id="list3">if array[j]>array[j+1]</li><li id="list5"> {</li>
                             <li id="list4">swap(array[j],array[j+1])</li>
                             <li id="list5">}</li>
                            <li id="list6">}</li>
                            <li id="list7">}</li>`
        ...
        for(let j=0;j<bars.length-i-1;j+=1)
        {
            algo_main.innerHTML=`<li>for i=0 to array.length</li><li id="list7"> {</li>
                             <li id="list2" class="class1">for j=0 to last unsorted</li><li id="list6"> {</li>
                             <li id="list3">if array[j]>array[j+1]</li><li id="list5"> {</li>
                             <li id="list4">swap(array[j],array[j+1])</li>
                             <li id="list5">}</li>
                            <li id="list6">}</li>
            ...
            let val2 = Number(bars[j+1].childNodes[0].innerHTML)

            
            algo_main.innerHTML=`<li>for i=0 to array.length</li><li id="list7"> {</li>
                             <li id="list2">for j=0 to last unsorted</li><li id="list6"> {</li>
                             <li id="list3" class="class1">if array[j]>array[j+1]</li><li id="list5"> {</li>
                             <li id="list4">swap(array[j],array[j+1])</li>
                             <li id="list5">}</li>
                            <li id="list6">}</li>
                            <li id="list7">}</li>`
            ...
            if(val1>val2)
            {
                ...
                algo_mutable.innerHTML = `<li>swapping ${val1} & ${val2}</li>`


                algo_main.innerHTML=`<li>for i=0 to array.length</li><li id="list7"> {</li>
                             <li id="list2">for j=0 to last unsorted</li><li id="list6"> {</li>
                             <li id="list3" >if array[j]>array[j+1]</li><li id="list5"> {</li>
                             <li id="list4" class="class1">swap(array[j],array[j+1])</li>
                             <li id="list5">}</li>
                            <li id="list6">}</li>
                            <li id="list7">}</li>`
            ...
            bars[j+1].style.backgroundColor = "rgb(212, 84, 24)"
        }
